function [inSegment, IntersectionX, IntersectionY, IntersectionZ]=lineIntersectsTriangle_1(Line1,Line2, V1,V2,V3)
...
%             if  ((dot([IntersectionX, IntersectionY, IntersectionZ]-[LineX1, LineY1, LineZ1],[LineX2, LineY2, LineZ2]-[LineX1, LineY1, LineZ1]) >0) |...
%                 abs(dot([IntersectionX, IntersectionY, IntersectionZ]-[LineX1, LineY1, LineZ1],[LineX2, LineY2, LineZ2]-[LineX1, LineY1, LineZ1]))<tol)...
%                     & ((dot([IntersectionX, IntersectionY, IntersectionZ]-[LineX2, LineY2, LineZ2],[LineX2, LineY2, LineZ2]-[LineX1, LineY1, LineZ1]) < 0) |...
%                 abs(dot([IntersectionX, IntersectionY, IntersectionZ]-[LineX2, LineY2, LineZ2],[LineX2, LineY2, LineZ2]-[LineX1, LineY1, LineZ1]))<tol)
%             if (norm(cross([IntersectionX, IntersectionY, IntersectionZ]-[LineX1, LineY1, LineZ1],[LineX2, LineY2, LineZ2]-[LineX1, LineY1, LineZ1])) < 1e-4) & ...
%                 (dot([IntersectionX, IntersectionY, IntersectionZ]-[LineX1, LineY1, LineZ1],[LineX2, LineY2, LineZ2]-[LineX1, LineY1, LineZ1]) >= 0) & ...
%                 (dot([IntersectionX, IntersectionY, IntersectionZ]-[LineX2, LineY2, LineZ2],[LineX2, LineY2, LineZ2]-[LineX1, LineY1, LineZ1]) <= 0)
            if  (dot([IntersectionX, IntersectionY, IntersectionZ]-[LineX1, LineY1, LineZ1],[LineX2, LineY2, LineZ2]-[LineX1, LineY1, LineZ1]) >= 0) ...
                    & (dot([IntersectionX, IntersectionY, IntersectionZ]-[LineX2, LineY2, LineZ2],[LineX2, LineY2, LineZ2]-[LineX1, LineY1, LineZ1]) <= 0)
%                %  --- POINT ---- 
...
%     IsOnRightSide = NumLeft < 0;
    tol=1e-10;
    IsOnLeftSide = NumLeft > tol;
    IsOnLine = abs(NumLeft)<=tol;
    IsOnRightSide = NumLeft < -tol;
end
...
function [IsIntersection, IsOverlap, IntersectionX, IntersectionY, IntersectionZ] = ...
    ...
    % by three points intersects the plane given by two points.
    ...
    tol=1e-10;
    if (abs(IntersectionTVard)>tol)%(IntersectionTVard ~= 0)
        IsIntersection = true;
        IsOverlap = false;
        ...
        IntersectionY = 0;
        IntersectionZ = 0;
        if abs(IntersectionTSkait )>tol%(IntersectionTSkait ~= 0)
            IsOverlap = false;
        else
            IsOverlap = true;
        end
